...
| [registry-syncer](./registry-syncer/SKILL.md) | Rebuilds the LLM registry from source and syncs to all SDKs. Invoke when user updates registry, modifies providers, or asks to sync/build registry. | See details in file |
